...
exports.removeFavoriteRestaurant = exports.addFavoriteRestaurant = exports.getFavoriteRestaurants = exports.getNearbyRestaurants = exports.getRestaurants = void 0;
...
const getRestaurants = async (req, res) => {
    try {
        ...
        const restaurants = await storage_1.storage.getRestaurants(cuisineType);
...
const getNearbyRestaurants = async (req, res) => {
    try {
        ...
        const restaurants = await storage_1.storage.getNearbyRestaurants(lat, lng, radius);
        // Rimuovi le password dalle risposte
        const sanitizedRestaurants = restaurants.map(restaurant => {
            const { password, ...rest } = restaurant;
            return rest;
...
const getFavoriteRestaurants = async (req, res) => {
    try {
        ...
        const favoriteRestaurants = await storage_1.storage.getRestaurantsByIds(user.favoriteRestaurants);
        // Rimuovi le password dalle risposte
...
const addFavoriteRestaurant = async (req, res) => {
    try {
        ...
        const restaurant = await storage_1.storage.getUser(restaurantId);
        ...
        const updatedUser = await storage_1.storage.updateUser(user.id, {
...
exports.default = {
    ...
    getNearbyRestaurants: exports.getNearbyRestaurants,
    getFavoriteRestaurants: exports.getFavoriteRestaurants,
    addFavoriteRestaurant: exports.addFavoriteRestaurant,
    removeFavoriteRestaurant: exports.removeFavoriteRestaurant,
};
